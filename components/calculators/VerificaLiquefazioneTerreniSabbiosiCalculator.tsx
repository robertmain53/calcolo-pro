...
const VerificaLiquefazioneTerreniSabbiosiCalculator: React.FC = () => {
  ...
  return (
    <div className="p-4">
      <h1>Verifica Liquefazione Terreni Sabbiosi Calculator</h1>
      <p>Metodo semplificato di Seed e Idris (NTC 2018)</p>
...
export default VerificaLiquefazioneTerreniSabbiosiCalculator;