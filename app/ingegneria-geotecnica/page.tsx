// app/ingegneria-geotecnica/page.tsx - Generato automaticamente
...
const CATEGORY_CONFIG = {
  ...
  features: [
    {
      name: 'Eurocodice 7',
      description: 'Calcoli secondo EC7 e NTC 2018 per geotecnica',
      icon: CheckCircleIcon
    },
    {
      name: 'Stabilità Pendii',
      description: 'Analisi di stabilità con diversi metodi',
      icon: DocumentTextIcon
    },
    {
      name: 'Fondazioni',
      description: 'Calcolo portanza e cedimenti fondazioni',
      icon: UserGroupIcon
    }
  ]
};
