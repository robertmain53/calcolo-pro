// app/acustica-e-termotecnica/page.tsx
...
const CATEGORY_CONFIG = {
  slug: 'acustica-e-termotecnica',
  name: 'Acustica e Termotecnica',
  description: 'Calcoli specializzati per isolamento acustico, trasmittanza termica e analisi energetica degli edifici secondo normative UNI, EN e ISO',
  icon: '🎧',
  ...
  features: [
    {
      name: 'Normative Aggiornate',
      description: 'Calcoli conformi a UNI EN ISO 12354, UNI 11367, NTC 2018',
      icon: CheckCircleIcon
    },
    {
      name: 'Report Professionali',
      description: 'Output dettagliati con grafici e tabelle esportabili',
      icon: DocumentTextIcon
    },
    {
      name: 'Precisione Certificata',
      description: 'Algoritmi validati da ingegneri esperti del settore',
      icon: UserGroupIcon
    }
  ]
};
...
const calculatorMeta: Record<string, {
  ...
  'trasmittanza-termica-infissi-uw': {
    ...
    featured: true,
    description: 'Calcolo Uw degli infissi secondo UNI EN ISO 10077'
  },
  'isolamento-acustico-facciata': {
    difficulty: 'Avanzato',
    estimatedTime: '5-10 min',
    featured: true,
    description: 'Isolamento acustico facciate secondo UNI EN ISO 12354-3'
  },
  'potere-fonoisolante-rw': {
    difficulty: 'Avanzato',
    estimatedTime: '5-8 min',
    featured: true,
    description: 'Calcolo potere fonoisolante secondo UNI EN ISO 12354-1'
  },
  'tempo-riverberazione': {
    difficulty: 'Medio',
    estimatedTime: '2-4 min',
    description: 'Calcolo T60 con formule di Sabine ed Eyring'
  },
  'rumore-calpestio-lnw': {
    difficulty: 'Avanzato',
    estimatedTime: '4-7 min',
    description: 'Livello di rumore di calpestio secondo UNI EN ISO 12354-2'
  },
  'verifica-condensa-glaser': {
    difficulty: 'Medio',
    estimatedTime: '4-6 min',
    description: 'Verifica condensa con metodo di Glaser UNI EN ISO 13788'
  },
  'trasmittanza-termica-pareti-coperture': {
    difficulty: 'Medio',
    estimatedTime: '4-7 min',
    description: 'Calcolo trasmittanza U secondo UNI EN ISO 6946'
  }
};
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Strumenti progettati specificamente per professionisti del settore termotecnico e acustico
            </p>
          </div>
        ...
        <div id="calcolatori" className="bg-white py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                I nostri strumenti più utilizzati dai professionisti del settore
              </p>
            </div>
