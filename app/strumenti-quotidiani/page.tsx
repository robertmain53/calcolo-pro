// app/strumenti-quotidiani/page.tsx - Generato automaticamente
...
const CATEGORY_CONFIG = {
  ...
  features: [
    {
      name: 'Utilizzo Immediato',
      description: 'Interfaccia semplice e risultati istantanei',
      icon: CheckCircleIcon
    },
    {
      name: 'Multifunzione',
      description: 'Dalle percentuali alle aree, tutto in un posto',
      icon: DocumentTextIcon
    },
    {
      name: 'Sempre Disponibili',
      description: 'Accesso rapido per calcoli di tutti i giorni',
      icon: UserGroupIcon
    }
  ]
};
