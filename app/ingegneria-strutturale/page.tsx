// app/ingegneria-strutturale/page.tsx - Generato automaticamente
...
const CATEGORY_CONFIG = {
  ...
  features: [
    {
      name: 'NTC 2018 Compliant',
      description: 'Calcoli conformi alle Norme Tecniche per le Costruzioni',
      icon: CheckCircleIcon
    },
    {
      name: 'Analisi Sismica',
      description: 'Verifiche sismiche e spettri di risposta',
      icon: DocumentTextIcon
    },
    {
      name: 'Elementi Strutturali',
      description: 'Dimensionamento travi, pilastri, fondazioni',
      icon: UserGroupIcon
    }
  ]
};
