// app/finanza-e-business/page.tsx - Generato automaticamente
  ...
  features: [
    {
      ...
      description: 'VAN, TIR, payback period e analisi di fattibilità',
      icon: CheckCircleIcon
    },
    {
      name: 'Valutazioni Aziendali',
      description: 'DCF, multipli di mercato, business plan',
      icon: DocumentTextIcon
    },
    {
      name: 'Decisioni Strategiche',
      description: 'Strumenti per il management e la pianificazione',
      icon: UserGroupIcon
    }
  ]
};
