...
async function getContent(slug: string) {
  try {
    const contentPath = path.join(process.cwd(), 'content', 'convertitori-tecnici-avanzati', `${slug}.md`);
...
export default async function CalculatorPage({ params }: Props) {
  ...
  const crumbs = [
      { name: "Home", path: "/" },
      { name: "Convertitori Tecnici Avanzati", path: "/convertitori-tecnici-avanzati" },
      { name: calculatorName }
  ];
