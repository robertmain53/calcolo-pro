// app/convertitori-tecnici-avanzati/page.tsx - Generato automaticamente
...
const CATEGORY_CONFIG = {
  slug: 'convertitori-tecnici-avanzati',
  name: 'Convertitori Tecnici Avanzati',
  description: 'Conversioni professionali per unità di misura, classi di materiali, pressioni e grandezze fisiche secondo standard internazionali',
  icon: '🔄',
  ...
  features: [
    {
      name: 'Standard Internazionali',
      description: 'Conversioni basate su normative ISO, ASTM, EN',
      icon: CheckCircleIcon
    },
    {
      name: 'Precisione Assoluta',
      description: 'Algoritmi di conversione certificati e validati',
      icon: DocumentTextIcon
    },
    {
      name: 'Interfaccia Intuitiva',
      description: 'Conversioni immediate con aggiornamento in tempo reale',
      icon: UserGroupIcon
    }
  ]
};
