...
async function getCalculators() {
    const calculatorsPath = path.join(process.cwd(), 'content', 'computo-sicurezza-e-cantiere-10-calcolatori');
    try {
...
export default async function CategoryPage() {
  ...
  const categoryName = "Computo, Sicurezza e Cantiere (10 Calcolatori)";
