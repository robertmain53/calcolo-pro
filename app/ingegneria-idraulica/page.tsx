// app/ingegneria-idraulica/page.tsx - Generato automaticamente
...
const CATEGORY_CONFIG = {
  ...
  features: [
    {
      name: 'Formule Classiche',
      description: 'Hazen-Williams, Darcy-Weisbach, Manning',
      icon: CheckCircleIcon
    },
    {
      name: 'Reti Complesse',
      description: 'Analisi di reti di distribuzione e collettori',
      icon: DocumentTextIcon
    },
    {
      name: 'Perdite di Carico',
      description: 'Calcoli precisi per ogni tipologia di sistema',
      icon: UserGroupIcon
    }
  ]
};
